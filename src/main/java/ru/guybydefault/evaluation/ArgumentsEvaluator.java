...
public class ArgumentsEvaluator implements ISymbolVisitor<CalculationResult> {
    ...
    public CalculationResult visitExpression(Expression expression) {
        ...
        List<CalculationResult> argsCalculationResult = evaluateArguments(headCalculationResult.getResult(), expression.getArguments());
        ...
        for (CalculationResult argCalculationResult : argsCalculationResult) {
            ...
            args.add(argCalculationResult.getResult());
        }

        return new CalculationResult(argCalculationSteps, new Expression(headCalculationResult.getResult(), args));
    }
